...
void zeci(int n){
    if(n/10%10==1 && n%10==0) cout<<"zece";
    if(n/10%10==2) cout<<"douazeci";
    if(n/10%10==3) cout<<"treizeci";
    if(n/10%10==4) cout<<"patruzeci";
    if(n/10%10==5) cout<<"cincizeci";
    if(n/10%10==6) cout<<"saizeci";
    if(n/10%10==7) cout<<"saptezeci";
    if(n/10%10==8) cout<<"optzeci";
    if(n/10%10==9) cout<<"nouazeci";
}
void numar(int n){
    if(n==14) cout<<"paisprezece";
    else if(n==11) cout<<"unsprezece";
        else if(n>0 && n<10) unit(n);
        else if(n<20 && n>0 && n!=10) {unit(n); cout<<"sprezece";}
